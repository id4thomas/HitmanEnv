...
for ep_i in range(100000):
    ...
    print('Episode #{} total reward: {} step: {} path {} actions {}: '.format(ep_i, cnt, step_count, path, actions))
    ...
    if ep_i % 50 == 0 and ep_i != 0:
        main_network.save_model('./dueling_dqn/model_ep{}.h5'.format(ep_i))